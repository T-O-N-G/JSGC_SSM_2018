...
//        return contractMapper.insertSelective(contract);
    ...
    public int ifSerialExistAdd(String contractSerial) {
        return contractMapper.ifSerialExistAdd(contractSerial);
    }

    ;

    public int ifSerialExistUpdt(Contract contract) {
        return contractMapper.ifSerialExistUpdt(contract);
    }

    public int getContractIDBySerial(String contractSerial) {
        return contractMapper.getContractIDBySerial(contractSerial);
    }
